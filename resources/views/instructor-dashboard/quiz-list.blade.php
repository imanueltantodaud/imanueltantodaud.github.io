                                                ...
                                                @foreach($quiz_ists as $quiz_ist)
                                                    <tr data-id="1">
                                                        ...
                                                        <td style="width: 100px; display: ruby;">
                                                            <form >
                                                            <a href="{{ route('InstructorUpdateQuiz', [$quiz_ist->id]) }}" class="btn btn-outline-secondary btn-sm edit" title="Edit">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                            </form>
                                                            <form action="{{ route('InstructorDeleteQuiz', [$quiz_ist->id]) }}" method="post">
                                                                @csrf
