                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <form action="{{ route('AddBlogStore') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                        <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="blog_title" id="formrow-email-input" required>
                                                    </div>
                                                </div>
                                            </div>
